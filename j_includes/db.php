...
if(!class_exists('PlanterDatabase')){
	class PlanterDatabase {
		 ...
		 *
		 * @uses PlanterDatabase::__construct()
		 *
		 */	
		function PlanterDatabase() {
		...
		function connect() {
			...
			if (!$db_selected) {
				die('Can\'t use ' . DB_NAME . ': ' . mysql_error($link));
			}
		}
